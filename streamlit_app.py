...
#             with st.spinner("Setting location..."):
#                 try:
#                     resp = requests.post(f"https://51eaaa9153a6.ngrok-free.app/init-location?pincode={pincode_input}")
#                     if resp.status_code == 200:
#                         st.session_state.pincode = pincode_input
#                         st.success(f"✅ Location set: {pincode_input}")
#                         st.rerun()
...
#                     # Get keywords
#                     kw_resp = requests.get(f"https://51eaaa9153a6.ngrok-free.app/keywords?query={requests.utils.quote(user_query)}")
#                     if kw_resp.status_code != 200:
#                         st.error("Failed to understand your query.")
#                         st.stop()
#                     keywords = kw_resp.json().get("keywords", [])
...
#                         with st.spinner(f"Searching for '{kw}'..."):
#                             search_resp = requests.get(
#                                 f"https://51eaaa9153a6.ngrok-free.app/search?keyword={kw}&pincode={st.session_state.pincode}"
#                             )
#                             if search_resp.status_code == 200:
#                                 data = search_resp.json()
#                                 for r in data["results"]:
...
#             # 🔥 Use your ngrok URL
#             resp = requests.get(
#                 f"https://51eaaa9153a6.ngrok-free.app/search",
...
#                     try:
#                         resp = requests.post(
#                             f"https://51eaaa9153a6.ngrok-free.app/init-location",
...
#                         f"https://51eaaa9153a6.ngrok-free.app/keywords?query={keyword}"
#                     )
